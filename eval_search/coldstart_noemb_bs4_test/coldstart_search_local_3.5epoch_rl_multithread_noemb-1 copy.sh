...
LOG_FILE="$BASE_PATH/log/test_search_noemb_bs4_$(date +%Y%m%d_%H%M%S).log"
# 注意device设置
export CUDA_VISIBLE_DEVICES=5
echo "GPU: $CUDA_VISIBLE_DEVICES"

nohup python3 $BASE_PATH/test_search_local_3.5epoch_rl_noemb-1.py \
    --model "/diskpool/home/xuxz/Code-for-DPEPO/3emb_model_bs2/search_no_emb_bs2/global_step_125/merged" \
