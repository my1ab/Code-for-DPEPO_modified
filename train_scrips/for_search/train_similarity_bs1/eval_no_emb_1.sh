...
# ========== 输出路径（本脚本独占） ==========
ckpt_dir=${_CODE_BASE}/3emb_model_bs1/search_noemb_bs1
LOG_FILE="$ckpt_dir/log/search_noemb_bs1_$(date +%Y%m%d_%H%M%S).log"
...
custom_emb_threshold=0.7     # 阈值 0.8（激进）
...
nohup python3 train_scrips/for_search/main_ppo_search.py \
    ...
    trainer.experiment_name='grpo_1.5b_search_emb070_bs2' \
