...
class TaskRunner:
    def run(self, config):
        ...
        from agent_system.environments import build_parallel_sciworld_envs 
        ...
        if not lazy_envs: 
            ...
            parallel_envs = build_parallel_sciworld_envs(
                gamefiles=gamefiles,
            ...
            build_env_func = build_parallel_sciworld_envs
        ...
        from agent_system.multi_turn_rollout import TrajectoryCollectorParallelSciWorld 
        traj_collector = TrajectoryCollectorParallelSciWorld(config=config, tokenizer=tokenizer, processor=processor)

        from verl.utils.dataset.rl_dataset import collate_fn
        # Create the Training and Validate Datasets 
        ...
        trainer.init_workers() # take a lof of times (Loading Models and Other Workers)
