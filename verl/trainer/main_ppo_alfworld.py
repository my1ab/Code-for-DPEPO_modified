...
class TaskRunner:
    def run(self, config):
        ...
        if not lazy_envs:
            ...
            build_env_func = build_parallel_alfworld_envs
        ...
        from agent_system.multi_turn_rollout import TrajectoryCollectorParallel 
        traj_collector = TrajectoryCollectorParallel(config=config, tokenizer=tokenizer, processor=processor)
